...
| Recall against the non-conformant fixture | **95%** (37 of 39 seeded violations detected) |
| False positives against the conformant fixture | **0** |
| Scan wall-clock | p50 **60 ms**, p95 **102 ms** |
...
**Result:** **95%** (37 of 39 seeded violations detected)

**Value:** MCP/MUST 33/34 (97%); MCP/SHOULD 3/4 (75%); SENTINEL/SHOULD 1/1 (100%). Undetected: `MCP/2026-07-28/MUST/response-content-type-valid`, `MCP/2026-07-28/SHOULD/get-delete-405`
