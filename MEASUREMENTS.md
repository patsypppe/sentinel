...
| Recall against the non-conformant fixture | **100%** (31 of 31 seeded violations detected) |
| False positives against the conformant fixture | **0** |
| Scan wall-clock | p50 **56 ms**, p95 **84 ms** |
...
**Result:** **100%** (31 of 31 seeded violations detected)

**Value:** MCP/MUST 27/27 (100%); MCP/SHOULD 3/3 (100%); SENTINEL/SHOULD 1/1 (100%)
