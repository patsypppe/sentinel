...
| Recall against the non-conformant fixture | **100%** (32 of 32 seeded violations detected) |
| False positives against the conformant fixture | **0** |
| Scan wall-clock | p50 **53 ms**, p95 **78 ms** |
...
**Result:** **100%** (32 of 32 seeded violations detected)

**Value:** MCP/MUST 28/28 (100%); MCP/SHOULD 3/3 (100%); SENTINEL/SHOULD 1/1 (100%)
